package com.dace.textreader.view.tab;
 ...
 * Packname com.dace.textreader.view.tab
 * Created by Administrator.
 * Created time 2018/11/23 0023 下午 6:20.
 * Version   1.0;
 * Describe :
 * History:
 * ==============================================================================
...
public class SmartTabLayout extends HorizontalScrollView {
     ...
     * @param clickable
     */
    public void setInternalTabClickable(boolean clickable) {
        this.internalTabClickListener = clickable ? new InternalTabClickListener() : null;
    }
    ...
    private int position = -1;  //当前选中的item
