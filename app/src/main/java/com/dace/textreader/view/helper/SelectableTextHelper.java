package com.dace.textreader.view.helper;
...
/**
 * Created by 70391 on 2017/11/14.
 */
...
public class SelectableTextHelper {
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
            View contentView = LayoutInflater.from(context).inflate(R.layout.operate_popup_window_layout, null);
            ...
            contentView.findViewById(R.id.ll_copy_popup).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ClipboardManager clip = (ClipboardManager)
                            mContext.getSystemService(Context.CLIPBOARD_SERVICE);
                    clip.setPrimaryClip(ClipData.newPlainText(
                            mSelectionInfo.mSelectionContent, mSelectionInfo.mSelectionContent));
                    if (mSelectListener != null) {
                        mSelectListener.onTextSelected(mSelectionInfo.mSelectionContent);
                    }
            ...
            contentView.findViewById(R.id.ll_under_line_popup).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    if (mOnUnderLineClick != null) {
                        mOnUnderLineClick.onUnderLineClick(mSelectionInfo.mStart, mSelectionInfo.mEnd);
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
            ...
            contentView.findViewById(R.id.ll_note_popup).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mOnNoteClick != null) {
                        mOnNoteClick.onNoteClick(mSelectionInfo.mStart, mSelectionInfo.mEnd);
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
            ...
            contentView.findViewById(R.id.ll_grammar_popup).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mOnGrammarClick != null) {
                        mOnGrammarClick.onGrammarClick(mSelectionInfo.mStart, mSelectionInfo.mEnd);
                    }
                    SelectableTextHelper.this.resetSelectionInfo();
                    SelectableTextHelper.this.hideSelectView();
                }
    ...
    public interface OnUnderLineClick {
        void onUnderLineClick(int start, int end);
    }

    private OnUnderLineClick mOnUnderLineClick;

    public void setOnUnderLineClickListener(OnUnderLineClick onUnderLineClick) {
        this.mOnUnderLineClick = onUnderLineClick;
    }

    public interface OnGrammarClick {
        void onGrammarClick(int start, int end);
    }

    private OnGrammarClick mOnGrammarClick;

    public void setOnGrammarClickListener(OnGrammarClick onGrammarClick) {
        this.mOnGrammarClick = onGrammarClick;
    }

    public interface OnNoteClick {
        void onNoteClick(int start, int end);
    }

    private OnNoteClick mOnNoteClick;

    public void setOnNoteClickListener(OnNoteClick onNoteClick) {
