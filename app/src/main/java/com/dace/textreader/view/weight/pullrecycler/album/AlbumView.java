...
public class AlbumView extends GLSurfaceView implements View.OnTouchListener,
    ...
    public boolean isFirstFlipped = true;
...
//        return ((this.getCurrentIndex() == mPageProvider.getPageCount() && (isOnRect(this.mRenderer.getPageRect(CurlRenderer.PAGE_RIGHT), this.mPointerPos.mPos))  && !isSecondFlipped)
//                || (this.isSecondFlipped && (isOnRect(this.mRenderer.getPageRect(CurlRenderer.PAGE_LEFT), this.mPointerPos.mPos))));
   return false;
    }
    ...
    public boolean onTouch(View view, MotionEvent me) {
        ...
        switch (me.getAction()) {
            case MotionEvent.ACTION_DOWN: {
                ...
                int getpageCount = mPageProvider.getPageCount();
                ...
                if (isFirstFlipped && !isSecondFlipped) {
                    ...
                    // Otherwise check pointer is on right page's side.
                            ...
                            && mCurrentIndex < getpageCount && !mAnimate) {
                        mDragStartPos.x = rightRect.right;

                        if (!mAllowLastPageCurl
                                && mCurrentIndex >= getpageCount) {
                            return false;
                        }
