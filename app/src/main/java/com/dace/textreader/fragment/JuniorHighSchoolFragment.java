 ...
 * Created time 2017/12/7 0007 下午 1:42.
 * Version   1.0;
 * Describe :  初中
 * History:
 * ==============================================================================
...
public class JuniorHighSchoolFragment extends Fragment {
    ...
    private String grade = "初一上";
    private int gradeId = 211;  //年级对应的ID
    private int pageNum = 1;  //页码
    private int pageSize = 15;  //每页的文章数量

    private boolean refreahing = false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_junior_high_school, container, false);
    ...
    private void initData() {
        ...
        if (NewClassesActivity.GRADE_CODE == 1) {
            grade = DataUtil.gradeCode2Grade(NewMainActivity.GRADE_ID, 1);
            if (!grade.equals("")) {
                ...
                gradeId = DataUtil.grade2GradeId(grade, 1);
                adapter_grade.setItemSelected(grade_position);
                recyclerView_grade.scrollToPosition(grade_position);
            }
        }
    ...
    private void initView() {
        recyclerView_version = view.findViewById(R.id.recycler_view_classes_junior_high_version);
        recyclerView_grade = view.findViewById(R.id.recycler_view_classes_junior_high_grade);

        frameLayout = view.findViewById(R.id.frame_junior_high_school);

        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_classes_junior_high);
        recyclerView = view.findViewById(R.id.recycler_view_classes_junior_high);
        ...
        adapter_version.setOnItemClickListener(
                new ClassesChooseRecyclerViewAdapter.OnRecyclerViewItemClickListener() {
                    ...
                    public void onItemClick(View view) {
                        if (refreahing) {
                            MyToastUtil.showToast(getContext(), "加载数据中");
                        } else {
    ...
    private void analyzeVersionData(String s) {
        try {
            ...
            if (status == 200) {
                ...
                JSONArray primaryArray = jsonObject.getJSONArray("初中");
