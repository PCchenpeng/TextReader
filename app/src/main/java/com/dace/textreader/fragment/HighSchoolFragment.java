...
public class HighSchoolFragment extends Fragment {
    ...
    private String grade = "高一上";
    private int gradeId = 311;  //年级对应的ID
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_high_school, container, false);
    ...
    private void initData() {
        ...
        if (NewClassesActivity.GRADE_CODE == 2) {
            grade = DataUtil.gradeCode2Grade(NewMainActivity.GRADE_ID, 2);
            if (!grade.equals("")) {
                ...
                gradeId = DataUtil.grade2GradeId(grade, 2);
    ...
    private void initView() {
        recyclerView_version = view.findViewById(R.id.recycler_view_classes_high_version);
        recyclerView_grade = view.findViewById(R.id.recycler_view_classes_high_grade);

        frameLayout = view.findViewById(R.id.frame_high_school);

        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_classes_high);
        recyclerView = view.findViewById(R.id.recycler_view_classes_high);
    ...
    private void analyzeVersionData(String s) {
        try {
            ...
            if (status == 200) {
                ...
                JSONArray primaryArray = jsonObject.getJSONArray("高中");
