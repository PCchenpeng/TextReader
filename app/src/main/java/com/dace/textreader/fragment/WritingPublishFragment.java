 ...
 * Created time 2018/7/17 0017 下午 2:34.
 * Version   1.0;
 * Describe :  发布的作文
 * History:
 * ==============================================================================
...
public class WritingPublishFragment extends Fragment {

    private static final String url = HttpUrlPre.HTTP_URL + "/select/composition/release/list";
    //删除草稿
    ...
    //发布作文隐私设置
    private static final String publishUrl = HttpUrlPre.HTTP_URL + "/release/writing/public/";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_writing_publish, container, false);
    ...
    private void initView() {
        frameLayout = view.findViewById(R.id.frame_writing_public_fragment);

        swipeRefreshLayout = view.findViewById(R.id.swipe_refresh_writing_public_fragment);
        recyclerView = view.findViewById(R.id.recycler_view_writing_public_fragment);
        ...
        NiceDialog.init()
                ...
                .setConvertListener(new ViewConvertListener() {
                    ...
                    protected void convertView(ViewHolder holder, final BaseNiceDialog dialog) {
                        ...
                        rl_private.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                showPublicOrNotDialog(position);
                                dialog.dismiss();
                            }
                        });
     ...
     * 显示隐私设置对话框
     */
    private void showPublicOrNotDialog(final int position) {
        final String id = mList.get(position).getId();
        isPublic = mList.get(position).getIsPublic();
        final int writingIsPublic = isPublic;
        NiceDialog.init()
                ...
                .setConvertListener(new ViewConvertListener() {
                    ...
                    protected void convertView(ViewHolder holder, final BaseNiceDialog dialog) {
                        ...
                        tv_sure.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                if (writingIsPublic != isPublic) {
                                    publicDraft(id, position);
                                }
                                dialog.dismiss();
                            }
                        });
     ...
     * 将发布作文设为公开或者私密
     */
    private void publicDraft(String id, int position) {
        mList.get(position).setIsPublic(isPublic);
        adapter.notifyDataSetChanged();
        new PublicSetting(this).execute(publishUrl, id, String.valueOf(isPublic));
    }
    ...
    private void submitReview(int position) {
        ...
        if (isCorrection) {
            if (onItemCorrectionClick != null) {
                onItemCorrectionClick.onClick(id, title, taskId, 0, type, wordsNum);
            }
            ...
            intent.putExtra("writing_area", 0);
            ...
            if (200 == jsonObject.optInt("status", -1)) {
                ...
                if (jsonArray.length() == 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (object.getString("wordNum").equals("") ||
                                object.getString("wordNum").equals("null")) {
                            writingBean.setWordsNum(0);
                        } else {
                        ...
                        writingBean.setIsPublic(object.optInt("isPublic", 1));
                        writingBean.setStatus(-1);
                        writingBean.setEditor(isCorrection);
                        writingBean.setSelected(false);
                        writingBean.setIndex(1);
    ...
    private static class GetData
            extends WeakAsyncTask<String, Void, String, WritingPublishFragment> {

        protected GetData(WritingPublishFragment fragment) {
            super(fragment);
        }

        @Override
        protected String doInBackground(WritingPublishFragment fragment, String[] strings) {
            try {
        ...
        @Override
        protected void onPostExecute(WritingPublishFragment fragment, String s) {
    ...
    private static class DeleteData
        ...
        protected DeleteData(WritingPublishFragment fragment) {
            super(fragment);
        }
    ...
    private static class GetCompetitionData
        ...
        protected GetCompetitionData(WritingPublishFragment fragment) {
            super(fragment);
        }
    ...
    private static class CheckCompetition
        ...
        protected CheckCompetition(WritingPublishFragment fragment) {
            super(fragment);
        }
    ...
    private static class SubmitCompetition
        ...
        protected SubmitCompetition(WritingPublishFragment fragment) {
            super(fragment);
        }
     ...
     * 隐私设置
     */
    private static class PublicSetting
            extends WeakAsyncTask<String, Void, String, WritingPublishFragment> {

        protected PublicSetting(WritingPublishFragment fragment) {
            super(fragment);
        }
        ...
        protected String doInBackground(WritingPublishFragment fragment, String[] strings) {
            try {
                ...
                object.put("id", strings[1]);
                object.put("studentId", NewMainActivity.STUDENT_ID);
                object.put("isPublic", Integer.valueOf(strings[2]));
                RequestBody body = RequestBody.create(DataUtil.JSON, object.toString());
                Request request = new Request.Builder()
                        .url(strings[0])
                        .post(body)
