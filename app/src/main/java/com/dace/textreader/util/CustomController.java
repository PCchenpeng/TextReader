...
public class CustomController  extends NiceVideoPlayerController
    ...
    private void init() {
        ...
        mCenterStart.setLayoutParams(params);
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
            ...
            case NiceVideoPlayer.STATE_PLAYING:
                ...
                mRestartPause.setImageResource(com.xiao.nicevideoplayer.R.drawable.ic_player_pause);
                startDismissTopBottomTimer();
                break;
            case NiceVideoPlayer.STATE_PAUSED:
                mLoading.setVisibility(View.GONE);
                mRestartPause.setImageResource(com.xiao.nicevideoplayer.R.drawable.ic_player_start);
        ...
        switch (playMode) {
            case NiceVideoPlayer.MODE_NORMAL:
                if(onScreenChangeListener != null){
                    onScreenChangeListener.onNormal();
                }
