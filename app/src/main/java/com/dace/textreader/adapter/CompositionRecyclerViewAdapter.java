...
public class CompositionRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public CompositionRecyclerViewAdapter(Context context, List<WritingBean> list, Typeface score) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext)
                .inflate(R.layout.item_composition_recommended_layout, parent, false);
...
//                HttpUrlPre.FILE_URL +
    ...
    public interface OnCompositionItemClick {
        void onItemClick(View view);
    }

    private OnCompositionItemClick mItemClickListener;

    public void setOnCompositionItemClick(OnCompositionItemClick listener) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            tv_title = itemView.findViewById(R.id.tv_writing_title_composition_item);
            tv_content = itemView.findViewById(R.id.tv_writing_content_composition_item);
            iv_user = itemView.findViewById(R.id.iv_writing_image_composition_item);
            tv_username = itemView.findViewById(R.id.tv_writing_author_composition_item);
            tv_score = itemView.findViewById(R.id.tv_writing_score_composition_item);
            iv_score = itemView.findViewById(R.id.iv_writing_score_composition_item);
            tv_comment = itemView.findViewById(R.id.tv_writing_comment_composition_item);
            tv_views = itemView.findViewById(R.id.tv_views_composition_item);
            ll_task = itemView.findViewById(R.id.ll_writing_task_recommend_item);
            tv_task = itemView.findViewById(R.id.tv_writing_task_recommend_item);
        }
    }
}
