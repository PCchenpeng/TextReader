...
public class ReaderTabAlbumDetailBookListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    private List<ReadTabAlbumDetailBean.DataBean.BookBean.ArticleListBean> itemData;
    private Context context;
    public ReaderTabAlbumDetailBookListAdapter(Context context , List<ReadTabAlbumDetailBean.DataBean.BookBean.ArticleListBean> itemData){
